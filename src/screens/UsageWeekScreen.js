...
const UsageWeekScreen = ({navigation}) => {
  const {getDataUsage, weekUsage, setIsLoading} = useContext(AuthContext);
...
export default UsageWeekScreen;
